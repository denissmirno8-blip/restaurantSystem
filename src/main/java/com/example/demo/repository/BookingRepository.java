...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("SELECT b FROM Booking b WHERE b.date = :date AND b.time = :time AND b.client IS NULL")
    List<Booking> findFreeTablesForBookingByDateAndTime(@Param("date") String date, @Param("time")String time);
