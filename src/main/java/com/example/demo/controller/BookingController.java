...
public class BookingController {
    ...
    @ResponseBody
    public ResponseEntity<List<Booking>> getTablesForBooking(@RequestParam String date, @RequestParam String time, @RequestParam Integer size) {
        return ResponseEntity.ok(bookingService.findTablesForBooking(date, time));
    }
